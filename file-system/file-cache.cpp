...
void file_cache_measurement() {
    ...
    // start from 1GB, end at 12GB, stripe is 1GB
    for (off_t block_number = 1024 * 1024; block_number <= 3 * 1024 * 1024;
        ...
        // cout << "Average cycles for reading a 4k block for a " << file_size /
        // 1024 / 1024 / 1024 << "GB file is " << (double)sum / (double)count <<
        // endl;
    }
    free(buffer);
}
